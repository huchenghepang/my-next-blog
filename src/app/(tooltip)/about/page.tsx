...
export default function About() {
  return (
    <div className="background max-w-4xl mx-auto px-6 py-10 bg-gradient-to-r from-teal-200 to-blue-300 text-cyan-50 dark:bg-zinc-900 dark:to-indigo-800 dark:text-gray-200 rounded-lg shadow-lg transition-all">
      <header className="flex flex-col sm:flex-row justify-between items-center mb-6">
        <h1 className="text-4xl font-bold text-cyan-50 dark:text-gray-200 mb-2 sm:mb-0">
          关于我
        </h1>
        <h3 className="text-2xl text-cyan-50 dark:text-gray-400">
          选择独自朝圣
        </h3>
      </header>
      <section className="space-y-6 ">
        <p className="text-lg text-cyan-50 dark:text-gray-300">
        ...
        <p className="text-lg text-cyan-50 dark:text-gray-300">
          对于英文名Jeff的来历，是因为王安石。他字介甫。恰巧碰到要注册Google的邮箱就取了Jeff这个英文名。哦对，其实还有Smith这个英文的姓，这个姓就不知道为什么取了，可能是因为九年义务教育，它出现的频率高吧。
        </p>
        <p className="text-lg text-cyan-50 dark:text-gray-300">
      ...
      <section className="mt-10 space-y-4">
        <h2 className="text-2xl font-semibold text-cyan-50 dark:text-gray-200">
          网络信息：
        </h2>
      ...
      <section className="mt-8">
        ...
        <p className="italic text-lg text-cyan-50 dark:text-gray-300">
      ...
      <section className="mt-8 space-y-4">
        ...
        <p className="text-lg text-cyan-50 dark:text-gray-300 mb-4">
          以下是我喜欢的一些事情，这真的可以证明我生活在一个幸福的时代。
        </p>
        <ul className="list-disc list-inside text-lg text-cyan-50 dark:text-gray-300 space-y-2">
          <li>喜欢这个世界虚伪的样子，它让我都感觉好像大有作为。</li>
          <li>喜欢那些处处为人着想的“制度”和“政策”，它让我都感觉未来可期。</li>
          <li>
            喜欢这个特殊的互联网，让我从来都不需要意识到我还需要自己主动去思考。
          </li>
        </ul>
      </section>
    </div>
